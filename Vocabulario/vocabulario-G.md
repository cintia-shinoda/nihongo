...
|  |  | entre esses |
|  |  | só |
|  |  | Não sabe? : Frase interrogativa na forma negativa |
|  |  | forma abreviada de "" |
|  |  | ameniza a expressão no final da frase. Geralmente usado pelas mulheres nas conversações |
|  |  |  |
...
|:---------:|:--------|:---------|
|  |  | decidi ~ |
|  |  | Poderia (nos) mostrar? Expressa um pedido na forma interrogativa |
|  |  | poderia ~ : Expressa um pequeno pedido |
|  |  | quando, depois de ~ |
|  |  | intenção. Algo pensado de antemão |
|  |  |  |
...
| ideograma | leitura | tradução |
|:---------:|:--------|:---------|
|  |  | linguagem de tratamento de "" "" "" |
|  |  | indica um assunto que se ouviu de alguém |
|  |  | sempre nessa ocasião |
|  |  | indica o material de que é feito |
|  |  | chaveiro |
|  |  | cada uma das pessoas ou coisas |
|  |  | providenciar |
|  |  |  |
...
|  |  | escolher |
|  |  | maneira polida de pedir um favor |
|  |  | pronome de tratamento da 2a. pessoa. Usado principalmente por homens para se dirigir a alguém da mesma posição social ou inferior |
|  |  | forma polida de "" |
|  |  | expressa um pedido para pegar e levar |
|  |  | esta loja |
...
| ideograma | leitura | tradução |
|:---------:|:--------|:---------|
| 敬語 | けいご | linguagem de tratamento |
| 少々 | しょうしょう | um pouco |
| 尊敬する | そんけいする | respeitar |
| 場合 | ばあい | caso |
| 上司 | じょうし | superior |
| 意味 | いみ | sentido |
| 先ほど | さきほど | há pouco (tempo) |
|  | つまり | ou seja |
|  |  | voltado a, direcionado a |
|  |  | demonstrar |
|  |  | enaltecer |
|  |  | termo de respeito |
|  |  | termo de modéstia |
